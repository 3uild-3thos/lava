  ...
  function finishIDL() {
    if (
      ...
      const programAlreadyExists = $workspaces[
        $selectedWorkspace
      ].accounts.some((account) => account.name === customProgramName);
...
{#if ready}
  ...
  >
    <CreateToken
      wallets={$workspaces[$selectedWorkspace]?.accounts.filter(
        (account) => account.kind === "wallet",
      ) ?? []}
      {token}
    ...
    <div class="tokens">
      ...
      <div class="common--header" style="padding-right:0;">
        ...
        <div class="header--buttons">
          <a href="/export" class="btn btn--primary workspace--btn btn--fit">
            ...
            {#each gettingStarted as step, index}
              ...
              >
                ...
                <div class="workspace--getting-started--step">
                  ...
                  <button class="btn btn--primary btn--fit getting-started--btn"
                    ><img
