...
* @returns {any}
*/
export function get_project_files(template_id, idl_string) {
    const ptr0 = passStringToWasm0(idl_string, wasm.__wbindgen_malloc, wasm.__wbindgen_realloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.get_project_files(template_id, ptr0, len0);
    return takeObject(ret);
}
...
async function __wbg_init(input) {
    ...
    if (typeof input === 'undefined') {
        input = new URL('soda_wasm_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
